...
export default function AdminDashboard() {
    ...
    return (
        <div className="container mt-6 mx-auto p-4 md:p-6">
                            ...
                            <Card className="lg:col-span-3">
                                ...
                                <CardContent>
                                    ...
                                    {formatDate(chamado.dataAbertura)}
                                                            ...
                                                            <TableCell
                                                                className="hidden md:table-cell">{formatDate(chamado.dataAbertura)}</TableCell>
                                                                        ...
                                                                        <DialogContent>
                                                                            ...
                                                                            {imageAntesUrl ? (
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p className="text-gray-500">Não foi
                                                                                        possível recuperar a imagem.</p>
                                                                                </div>
                                                                            )}
                                                                        </DialogContent>
                                                                    </Dialog>
